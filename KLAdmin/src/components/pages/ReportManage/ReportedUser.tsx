...
const ReportedUser: React.FC<UserId> = ({ user_id, username }) => {
                ...
                <ModalCustom >
                    <Box sx={{ backgroundColor: "white", width: "100%", justifyItems: "center" }}>
                        <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ color: "black" }}>
                            Thông tin người bị báo cáo
                        </Typography>
                    </Box>
                            ...
                            <TableBody>
                                <StyledTableRow >
                                    <StyledTableCell align="center" >
                                        <Typography variant='subtitle1' className='book_infor'>{userInfor?.id}</Typography>
                                    </StyledTableCell>
                                    <StyledTableCell align="center" sx={{ display: "flex", alignItems: "center", columnGap: 5 }}>
                                        {
                                            userInfor?.avatar ?
                                                <img src={`http://localhost:3300/${userInfor.avatar}`} alt="" style={{ height: 50, width: 50 }} />
                                                :
                                                <img src={logo} alt="" style={{ height: 50, width: 50 }} />
                                        }
                                        <Typography variant="subtitle1">{userInfor?.username}</Typography>
                                    </StyledTableCell>
